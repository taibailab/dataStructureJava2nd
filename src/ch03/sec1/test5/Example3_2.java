package ch03.sec1.test5;

import ch03.sec1.test4.LinkStack;

/**
 * 3.1.5.栈的应用
 * ->[3.2].大数加法问题：编程实现两个大数的加法运算。所谓大数是指超过整数最大上限的数，如18 452 543 389 943 209 752 345 473和8 123 542 678 432 986 899 334相
 * 加。(提示：可以把两个加数看成是数字字符串，将这些数的相应数字存储在两个堆栈中，并从栈中弹出数字执行加法)
 */
public class Example3_2 {
	...
	public String add(String a, String b) throws Exception {
		...
		while (!sA.isEmpty() && !sB.isEmpty()) {	// 加数和被加数同时为空
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("两个大数的和为：" + e.add("18 452 543 389 943 209 752 345 473", "8 123 542 678 432 986 899 334"));	// 输出运算结果
	}
