...
/**
 * 5.2.3.二叉树的存储结构<br>
 * ->3.二叉链式存储结构下二叉树类的描述<br>
 * ->二叉链式存储结构下的二叉树<br>
 * <p>
 * 5.3.二叉树的遍历<br>
 * 5.3.1.二叉树的遍历方法及其实现<br>
 * ->3.二叉树遍历操作实现的递归算法<br>
 * ->[算法5.1].先根遍历操作实现的递归算法。<br>
 * ->[算法5.2].中根遍历操作实现的递归算法。<br>
 * ->[算法5.3].后根遍历操作实现的递归算法。<br>
 * ->4.二叉树遍历操作实现的非递归算法<br>
 * ->[算法5.4].先根遍历操作实现的非递归算法。<br>
 * ->[算法5.5].中根遍历操作实现的非递归算法。<br>
 * ->[算法5.6].后根遍历操作实现的非递归算法。<br>
 * ->[算法5.7].层次遍历操作实现的非递归算法。<br>
 * <p>
 * 5.3.二叉树的遍历
 * 5.3.3.建立二叉树<br>
 * ->1.由先根和中根遍历序列建立一棵二叉树<br>
 * ->[算法5.16].由先根遍历序列和中根遍历序列建立一棵二叉树的算法。
 * ->2.由标明空子树的先根遍历序列建立一棵二叉树
 * ->[算法5.17].由标明空子树的先根遍历序列建立一棵二叉树的操作算法。
 */
public class BiTree {
